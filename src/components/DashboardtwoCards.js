...
function DashboardtwoCards(props) {
    return (
        <>
            <div className="dashboardTwocard w-1/4 rounded-lg flex items-center justify-between cursor-pointer bg-[#FFFFFF] grow shrink m-[5px]" style={{ height: "80px", width: "300px", padding: "15px"}}>
                <div className='flex'>
                    ...
                    <div className="cardText" style={{paddingLeft:"8px"}}>
                        <p className='font-semibold text-[#1E1E1E]'>{props.heading}</p>
                        <p className='font-semibold text-[#1E1E1E]'>{props.count}</p>
                    </div>
                </div>

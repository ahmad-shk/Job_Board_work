...
import NewConnectionscards from '../../components/NewConnectionscards';
import JobNewscards from '../../components/JobNewscards';
    ...
    <div className="dashboardTwo-wrapper w-full flex">
      <div className="dashboardTwo-left w-9/12 ">
        <div className="dashboardleftCards flex flex-wrap justify-between">
          <DashboardtwoCards heading={'Job Acceptance'} count={'11'} icon={""} iconBg={"#FF7239"}/>
          <DashboardtwoCards heading={'Job Rejection'} count={'38'} icon={""} iconBg={"#6347FF"}/>
          <DashboardtwoCards heading={'Applied Jobs'} count={'49'} icon={""} iconBg={"#02D052"}/>
        </div>
        <div className="dashboardTwo-center w-full flex mt-[10px] h-[600px] ">
        <div className="dashboardTwo-company-layoffs w-3/5 bg-[#FFFFFF] m-h-[] rounded-xl mr-[10px] p-[15px]">
        {/* ----- */}
        <div className="job-seeker leading-[30px] h-[100%]">
        <p className='font-semibold text-[#1E1E1E] text-[26px]'>Job Seeker Guidance</p>
        <p className='text-xs text-[#1E1E1E]'>Recommended based on your activity</p> 

        <div className='px-[15px]'>
            <p className='font-medium py-[10px] text-[16px] font-bold'> I want to improve my resume</p>
          <p  className='text-[16px]'>Explore our curated guide of expert-led courses, such as how to improve your resume and grow your network, to help you land your next opportunity.</p>
          <ul className='list-disc list-inside'>
            <li  className='text-[16px]'>Your resume is a compelling marketing document, not an autobiography.</li>
            <li  className='text-[16px]'>Make your resume unique by using your own voice, so you can stand out in the sea of resumes.</li>
            <li  className='text-[16px]'>Make the words earn their spot - say what you need to without being too brief or too wordy.</li>
          </ul>
        ...
        <div className="dashboardTwo-notification w-2/5 bg-[#FFFFFF] text-sm  rounded-xl pb-[10px]  h-[100%]">
          <div className="dashboardTwo-notification-header flex bg-[] h-[10%] justify-between items-center border-b-2 border-[#FFCB05]    " style={{padding:"10px"}}>
            ...
            <span onClick={()=>{navigate('/notifications')}}> <DashboardTwoButton text={'See all'} bg={'#FFCB05'}/> </span>
          </div>
        ...
        <div className="article-section w-[100%] rounded-xl mt-[10px] flex">
          ...
          <div className='p-[10px] w-[100%]  rounded-xl'>
            <p className= "text-[16px]">A job may be important for a sense of purpose since it can prov...</p>
          ...
          <div className=" bg-[#FFFFFF] article-right w-[65%] h-[100%] rounded-xl ml-[10px] " >
           ...
           <p className='text-[#1E1E1E] text-[16px]'>The Future of Work: Trends and Innovations to <br /> Watch in 2022. </p>
      ...
      <div className="newConnections-header flex justify-between py-[10px] items-center">
          <p className='font-semibold text-[18px]'>New Connections</p>

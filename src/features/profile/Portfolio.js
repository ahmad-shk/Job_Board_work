    ...
    const handleSave = async () => {
        ...
        try {
            dispatch(postProfileData({ portfolio: tabData })).unwrap().then(() => {
                ...
                notifySuccess('Portfolio Update Successfully')
            })
        } catch (e) {
        ...
        <div>
            ...
            <form >
                <div className="section-1 mb-10 overflow-hidden">
                    ...
                    <div className={`transition-all duration-300 ${collapse1 ? 'show' : 'hidden'}`}>
                        <div className=" mb-5 bg-[]">
                            <label className="mb-1 block">Resume CV/Resume</label>
                        ...
                        <div className="mb-5">
                            <label className="mb-1 block">Upload cover letter</label>
                            <span className="portfolio-file-upload-section flex gap-[40px]">
                                <input
                                    className="file-input file-input-bordered w-full max-w-xs font-15px"
                                    type="file"
                                    id="coverFile"
                                    name="file"
                                    accept='.pdf'
                        ...
                        <div className="portfolio-project-upload-section flex gap-[20px]">
                            <div className="portfolio-project-upload-left mb-5 w-6/12">
                                <label className="mb-1 block font-semibold">Upload Project</label>
                                <div className="relative py-2 h-[350px] gap-1 flex items-center justify-center flex-col border-[1px] border-dashed border-[#BFBFBF]">
                                    ...
                                    <h5 className="text-16 font-semibold mt-3">{loading2 ? <span className="loading"></span> : 'Upload Project'}</h5>
                            ...
                            </div>
                            {
                                ...
                                <div className="portfolio-project-upload-left mb-5 w-6/12">
                                    <label className="mb-1 block font-semibold ">Uplodes</label>
                        ...
                        <div className="mb-5">
                            <label className="mb-1 block">Upload Certification</label>
                            <span className="portfolio-file-upload-section flex gap-[40px]">
                                <input
                                    className="file-input file-input-bordered w-full max-w-xs font-15px"
                                    type="file"
                                ...
                                />
                                {tabData?.certifications?.length > 0 &&
                                    <span className="flex gap-[10px] justify-center items-center">
                                        <p className="font-semibold underline text-[#96b1ff] cursor-pointer" onClick={() => { previewFile(tabData.resume) }}>Download</p>
                                        <img src="assets/images/profile-portfolio-trash-icon.svg" onClick={() => { deleteFile('certifications') }} alt="" className="w-[15px] cursor-pointer" />
                                    </span>
                                }
                                {loading3 &&
                                    <span className="flex gap-[10px] justify-center items-center">
                ...
                <div className="text-end">
                    ...
                    <button type="button" onClick={handleSave} className="font-medium bg-[#FFCB05] px-[40px] text-[16px] rounded-[0px] py-[12px] border-0">{loadingSave ? <span className="loading"></span> : 'Save'}</button>
                </div>
            </form >

    ...
    <div className="hero min-h-full" style={{background: 'url(/assets/images/login-bg.png) center right no-repeat'}}>
      <div className="hero-content pt-[60px] pb-[150px]">
        <div className="max-w-md">
          ...
          <h1 className='text-[30px] text-center font-semibold mb-[100px]'><img src="/logo_1.png" className="w-[58px] h-[58px] inline-block mr-2 mask -mask-circle" alt="dashwind-logo" />Developer</h1>
